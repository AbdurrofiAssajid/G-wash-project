        ...
        <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="gallery/slide 1.jpg" class="d-block w-100" alt="...">
                    <div class="carousel-caption d-none d-md-block ">
                        <h5>Selamat Datang Di Website Kami</h5>
                        <i class="text-dark">Penyedia Jasa Laundry On Demand Terkemuka. </i>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="gallery/slide 2.jpg" class="d-block w-100" alt="...">
                    <div class="carousel-caption d-none d-md-block">
                        <h5>Terbesar se-Asia Tenggara</h5>
                        <i>Sudah lebih dari 3000 Cabang di Asia Tenggara</i>
                    </div>
                </div>
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        ...
                        <i>Dengan menyeidakan layanan jasa yang menggunakan aplikasi sebagai media utamanya dan memiliki
                            mitra yang
                            besar .</i>
                    </div>
                </div>
    ...
    <nav class="navbar bg-body-tertiary mt-5">
        <div class="container">
            <a class="navbar-brand" href="#">
                <img src="gallery/logo 5.png" alt="Logo" width="50" height="40" class="d-inline-block align-text-top">
